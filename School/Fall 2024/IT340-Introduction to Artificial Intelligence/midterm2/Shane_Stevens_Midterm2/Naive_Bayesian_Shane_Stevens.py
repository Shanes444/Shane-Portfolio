...
for email in testing_data:
    ...
    for word in email.split():
        if word in word_dict.keys():
            word_prob_ham = (word_dict[word][0] + 1)/(number_of_training_emails + ham_words)
            word_prob_spam = (word_dict[word][1] + 1)/(number_of_training_emails + spam_words)
        else:
           word_prob_ham = 1/(number_of_training_emails+ ham_words)
           word_prob_spam = 1/(number_of_training_emails+ spam_words) 
