...
void init(void)
{
	...
	shaderProgram1 = loadShader("../../src/shader/Question2_triangles1.vert",
		"../../src/shader/Question2_triangles1.frag");
	shaderProgram2 = loadShader("../../src/shader/Question2_triangles2.vert",
		"../../src/shader/Question2_triangles2.frag");
	shaderProgram3 = loadShader("../../src/shader/Question2_triangles3.vert",
		"../../src/shader/Question2_triangles3.frag");
	shaderProgram4 = loadShader("../../src/shader/Question2_triangles4.vert",
		"../../src/shader/Question2_triangles4.frag");
	shaderProgram5 = loadShader("../../src/shader/Question2_triangles5.vert",
		"../../src/shader/Question2_triangles5.frag");
...
void display()
{
	...
	//Then we draw the fourth triangle using the data from the second VAO
	//When we draw the fourth triangle we want to use a different shader program so we switch 
	glUseProgram(shaderProgram4);
	glBindVertexArray(VAOs[3]);


	//This call should output the fourth triangle
	glDrawArrays(GL_TRIANGLES, 0, 3);

	//Then we draw the fith triangle using the data from the second VAO
	//When we draw the fith triangle we want to use a different shader program so we switch 
	glUseProgram(shaderProgram5);
	glBindVertexArray(VAOs[4]);


	//This call should output the fith triangle
	glDrawArrays(GL_TRIANGLES, 0, 3);
...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Recitation02: Q02 Shane", NULL, NULL);
	if (window == NULL)
	{
