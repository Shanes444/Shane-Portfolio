...
void display()
{
	...
	//The view/projection transformations
...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Assignment 03:Q1 Shane", NULL, NULL);
	if (window == NULL)
	{
...
void processInput(GLFWwindow *window)
{
	...
	//Keyboard input for rendering control
