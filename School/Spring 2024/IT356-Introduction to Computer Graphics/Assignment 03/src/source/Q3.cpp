...
void init(void)
{
	...
	lightingShader = loadShader("../../src/shader/lighting_mapsQ3.vert", "../../src/shader/lighting_mapsQ3.frag");
	lampShader = loadShader("../../src/shader/lampQ3.vert", "../../src/shader/lampQ3.frag");
	...
	//Load textures 
	diffuseMap1 = loadTexture("../../src/resources/textures/smiley.jpg");

	//Load material diffuse
	glUseProgram(lightingShader);
	unsigned int materialDiffuseLoc1 = glGetUniformLocation(lightingShader, "material.diffuse1");
	glUniform1i(materialDiffuseLoc1, 0);

	diffuseMap2 = loadTexture("../../src/resources/textures/wood.png");

	glUseProgram(lightingShader);
	unsigned int materialDiffuseLoc2 = glGetUniformLocation(lightingShader, "material.diffuse2");
	glUniform1i(materialDiffuseLoc2, 0);
...
void display()
{
	...
	mixValue = abs(sin(glfwGetTime()));

	int timeLoc = glGetUniformLocation(lightingShader, "mixValue");
	glUniform1f(timeLoc, mixValue);
	...
	glUniform3f(materialSpecularLoc, 1.0f, 1.0f, 1.0f);
...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Assignment 03:Q3 Shane", NULL, NULL);
	if (window == NULL)
	{
